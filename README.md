...
Among some of the more common squat faults are: knees caving in, excessive forward lean, insufficient depth. This AI Squat Analyzer is a **proof of concept** designed to identify common squatting faults and subject point of view, not to designed to make authoritative judgments about exercise safety, clinical status, or technique quality.

Although built by a physical therapist learning applied ML, this tool is not a validated clinical assessment and should not be used as replacement for proper diagnostic clinical assessment. Possible uses may be for recreational use by fitness enthusiasts who lack the means to observe themselves properly, coaches, and clinical professionals as a supplementary educational tool.
